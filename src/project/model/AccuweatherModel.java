    ...
    public void getWeather(String selectedCity, Period period) throws IOException {
        switch (period) {
            case NOW:
                ...
                System.out.println("POGODA "+weatherResponse);
                String weatherMin = objectMapper.readTree(weatherResponse).at("/DailyForecasts").get(0).at("/Temperature")
                        .at("/Minimum").at("/Value").asText();
                String weatherMax = objectMapper.readTree(weatherResponse).at("/DailyForecasts").get(0).at("/Temperature")
                        .at("/Maximum").at("/Value").asText();

                System.out.printf("Погода в городе %s - %s min градусов, %s max градусов\n", selectedCity, weatherMin, weatherMax);
                break;
            case FIVE_DAYS:
                ...
                System.out.println("POGODA 5 DAY "+weatherResponseFiveDay);
                break;
        }
    }
